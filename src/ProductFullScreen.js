...
import img2 from './img/payments.png';
            ...
            <div className="col-lg-8 col-md-12">
                <div className="row">
                    ...
                    <div className="col-md-4 mb-5">
                        ...
                        <form action="">
                            <div className="form-group">
                                <input type="text" className="form-control border-0 py-4" placeholder="Your " required="required" />
                            </div>
                            <div className="form-group">
        ...
        <div className="row border-top border-light mx-xl-5 py-4">
            <div className="col-md-6 px-xl-0">
                <p className="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a className="text-dark font-weight-semi-bold" href="#">Your Site </a>. All Rights Reserved. Designed
                    by
